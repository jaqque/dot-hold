# Generated by Powerlevel10k configuration wizard on 2019-11-26 at 16:47 PST.
...
# no frame, light, compact, many icons, concise, transient_prompt,
...
() {
  ...
  # except it won't show the exit code, which is actually nice to know
